                    ...
                    <form className="space-y-6" onSubmit={handleSubmit}>
                        ...
                        <div className="relative">
                            <textarea  
                                ...
                                text-white transition focus:outline-none focus:border-green-500 focus:bg-green-500/5" 
                                placeholder="Message"
                        ...
                        <button
                            type="submit"
                            className="w-full bg-green-500 text-white py-3 px-6 rounded font-medium transition relative 
                            overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(86,224,58,0.4)] cursor-pointer"
                        >
                            Send Message
                        </button>
                    </form>
